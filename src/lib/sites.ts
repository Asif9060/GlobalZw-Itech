...
export const SITES: readonly SiteDefinition[] = [
  ...
  },
  {
    ...
    name: "About Us",
    brand: "GLOBALZW-iTECH",
    summary: "Company overview, core values and mission",
    path: "/about",
    formId: "",
    newsletterFormId: "newsForm",
    refPrefix: "AB",
  ...
  {
    slug: "services-and-projects",
    name: "Services & Projects",
    brand: "GLOBALZW-iTECH",
    summary: "Solar, traffic and electrical services with notable projects",
    path: "/services-and-projects",
    formId: "",
    newsletterFormId: "newsForm",
    refPrefix: "SP",
    accent: "#16a34a",
  ...
  {
    slug: "products-and-solutions",
    name: "Products & Solutions",
    brand: "GLOBALZW-iTECH",
    summary: "Traffic signal hardware, solar products and smart solutions",
  ...
  },
  {
    ...
    name: "Shop",
    brand: "GLOBALZW-iTECH",
    summary: "Hardware shop — signal heads, controllers, solar & electrical",
    path: "/shop",
    formId: "shopForm",
    newsletterFormId: "newsForm",
    refPrefix: "SH",
